...
const AppStorage = () => {
    ...
    const handleFecthDataStorge = () => {
        ...
        axios.get(`${BASE_URL}/classrooms/get-storage-classrooms`, config).then((response) => {
    ...
    const handleOptenStorageClass = () => {
        ...
        axios.patch(`${BASE_URL}/classrooms/${classroom_id}/open-storage`, {}, config).then((response) => {
            handleFecthDataStorge();
