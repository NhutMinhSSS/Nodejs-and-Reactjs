    ...
    const questions = [
        {
          ...
          student_exam: [
            { question_id: 1, answer_id: 3, student_exam_id: 1 },
          ]
        },
        {
          id: 2,
          ...
          student_exam: [
            { question_id: 2, answer_id: 6, student_exam_id: 1 }
          ]
        },
        {
          id: 3,
          ...
          student_exam: [
            { question_id: 3, answer_id: 9, student_exam_id: 1 }
          ]
        },
        {
          id: 4,
            ...
            student_exam: [
              { question_id: 4, "answer_id": 14, student_exam_id: 1 },
              { question_id: 4, "answer_id": 15, student_exam_id: 1 }
            ]
          },
          {
            id: 5,
            ...
            student_exam: [
              { question_id: 5, "answer_id": 17, student_exam_id: 1 },
              { question_id: 5, "answer_id": 19, student_exam_id: 1 }
            ]
          },
          {
            id: 6,
            ...
            answers: [],
            student_exam: [
              { question_id: 6, "answer_id": 'Tình yêu có thể tồn tại trong thời gian dài nếu được xây dựng trên cơ sở của sự hiểu biết, tôn trọng, lòng tin và cống hiến. Một mối quan hệ tình yêu bền vững yêu cầu cả hai bên cùng đồng ý và làm việc với nhau để duy trì và phát triển tình yêu qua thời gian.'+
